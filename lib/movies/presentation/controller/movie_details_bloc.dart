...
class MovieDetailsBloc extends Bloc<MovieDetailsEvent, MovieDetailsState> {
  ...
  FutureOr<void> _getMovieDetails(
    ...
    result.fold(
      (l) => emit(state.copyWith(
          movieDetailsState: RequstState.error,
          movieDetailsMessage: l.message)),
      (r) => emit(
        state.copyWith(
          movieDetail: r,
          movieDetailsState: RequstState.isLoaded,
        ),
      ),
    );
  }
  ...
  FutureOr<void> _getRecommendation(GetMovieRecommendationEvent event,
    ...
    result.fold(
          (l) => emit(state.copyWith(
          recommendationState: RequstState.error,
          recommendationMessage: l.message)),
          (r) => emit(
        state.copyWith(
          recommendation: r,
          recommendationState: RequstState.isLoaded,
        ),
      ),
    );
  }
